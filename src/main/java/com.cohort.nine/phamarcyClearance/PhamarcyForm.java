...
@WebServlet(
        name = "PharmacyForm",
        urlPatterns = "/pharmacy/form"
)
public class PhamarcyForm extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        display.print("<h3>Phamarcy clearance</h3>\n"
                + "\n"
            ...
            display.print("  <label for=\"IdLabel\">Patient ID:</label></br>\n"
                    ...
                    + "  <label for=\"druglabel\">Drug or Service:</label><br>\n"
                    ...
                    + "  <label for=\"clearLabel\">Cleared:</label><br>\n"
                    +"  <select name=\"clear\" id=\"clear\" form=\"clearform\">"
