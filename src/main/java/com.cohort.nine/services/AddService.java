...
public class AddService extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /*System.out.println("fffffffffffffff "+find.entrymethod());*/
        display.print("<html>");
        ...
        display.print("<h3>Add service</h3>");
        display.print("<form action=\"./save\" method=\"POST\">");
        /*for (int i=0; i<5;i++) {*/
            ...
            display.print("<input type=\"number\" id=\"quantity\" name=\"quantity\"><br></br>");
            display.print("<label for=\"pricelabel\">Price:</label><br>");
            display.print("<input type=\"number\" id=\"price\" name=\"price\"><br><br>");
        /*}*/
