...
@WebServlet(
        name = "Staff",
        urlPatterns = "staffs/form"
)

public class StaffForm extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        display.print("<h3>Staff Registration</h3>\n"
                + "\n"
                + "<form action=\"./save\" method=\"POST\">\n");


            display.print("<hr/>");
            display.print("  <label for=\"staffIdLabel\">staff ID:</label></br>\n"
                    +"  <input type=\"text\" id=\"staffId\" name=\"staffId\"><br><br>\n"

                    + "  <label for=\"namelabel\">staff Name:</label><br>\n"
                    + "  <input type=\"text\" id=\"name\" name=\"name\"><br>\n"

                    + "  <label for=\"departmentLabel\">Department:</label><br>\n"
