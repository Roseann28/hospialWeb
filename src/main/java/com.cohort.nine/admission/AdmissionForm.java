...
public class AdmissionForm extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        display.print("<h3>Admitted patient details</h3>\n"
                + "\n"
                + "<form action=\"./save\" method=\"POST\">\n");
        display.print("<hr/>");
        display.print("<label for=\"pdLabel\">Patient ID:</label><br>\n"
                + "  <input type=\"text\" id=\"pid\" name=\"pid\"><br><br>\n"

                + "  <label for=\"roomnolabel\">Room number:</label><br>\n"
                + "  <input type=\"text\" id=\"roomno\" name=\"roomno\"><br>\n"

                + "  <label for=\"doaLabel\">Date of Admissin:</label><br>\n"
                + "  <input type=\"date\" id=\"doa\" name=\"doa\"><br><br>\n"

                + "  <label for=\"pdLabel\">Present day:</label><br>\n"
                + "  <input type=\"date\" id=\"present\" name=\"present\"><br><br>\n"

                + "  <label for=\"progressLabel\">Progress:</label><br>\n"
                + "  <input type=\"text\" id=\"progress\" name=\"progress\"><br><br>\n"
        );
