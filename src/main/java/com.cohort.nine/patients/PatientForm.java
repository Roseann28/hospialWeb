...
public class PatientForm extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        display.print("<h3>Patients Form</h3>\n"
                + "\n"
                + "<form action=\"./save\" method=\"POST\">\n");

            display.print("<hr/>");
            display.print("  <label for=\"namelabel\">Name:</label><br>\n"
                    + "  <input type=\"text\" id=\"name\" name=\"name\"><br>\n"

                    + "  <label for=\"emailLabel\">Email:</label><br>\n"
                    + "  <input type=\"text\" id=\"email\" name=\"email\"><br><br>\n"

                    + "  <label for=\"nIdLabel\">National Id:</label><br>\n"
                    + "  <input type=\"text\" id=\"nId\" name=\"nId\"><br><br>\n"
                    + "  <label for=\"pMethodLabel\">Payment Method:</label><br>\n"
                    + "  <input type=\"text\" id=\"pmethod\" name=\"pmethod\"><br><br>\n");
